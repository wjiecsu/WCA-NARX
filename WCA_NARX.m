function [yPredTest,runtime]= ARFNNX(XInput1,XInput2,Ytrain,XtestInput1,XtestInput2,nMFs,alpha,beta1,beta2,lambda,corr_theta,Ratio_theta,MaxEpoch)
tic;
...
Testtime=toc;
save('WCA_NARXTestTime.mat','Testtime')
end
